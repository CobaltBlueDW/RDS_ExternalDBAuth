...
public class ExternalDBAuthenticator implements IdentityAuthenticator {
    ...
    public static final String PROP_JDBC_DRIVER = "com.sun.sgs.auth.ExternalDBAuthenticator.JDBC.driver";
    public static final String PROP_JDBC_LOCATION = "com.sun.sgs.auth.ExternalDBAuthenticator.JDBC.location";
    public static final String PROP_JDBC_USER = "com.sun.sgs.auth.ExternalDBAuthenticator.JDBC.user";
    public static final String PROP_JDBC_PASSWORD = "com.sun.sgs.auth.ExternalDBAuthenticator.JDBC.password";
    public static final String PROP_SALT = "com.sun.sgs.auth.ExternalDBAuthenticator.salt";
	public static final String PROP_ENCRYPTION = "com.sun.sgs.auth.ExternalDBAuthenticator.encryption";
	public static final String PROP_DB_TABLE = "com.sun.sgs.auth.ExternalDBAuthenticator.db.table";
	public static final String PROP_DB_USERNAME_FIELD = "com.sun.sgs.auth.ExternalDBAuthenticator.db.table.field.username";
	public static final String PROP_DB_PASSWORD_FIELD = "com.sun.sgs.auth.ExternalDBAuthenticator.db.table.field.password";
	public static final String PROP_DB_GAMEID_FIELD = "com.sun.sgs.auth.ExternalDBAuthenticator.db.table.field.gameid";
